    ...
    return (
        <section className="py-24 md:py-32 bg-neutral-950">
            <div className="mx-auto max-w-4xl px-6 text-center">
                ...
                >
                    <h2 className="text-3xl md:text-4xl lg:text-5xl font-medium text-white font-[family-name:var(--font-playfair)] mb-6">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                        ...
                        <Button
                            ...
                            size="lg"
                            variant="outline"
                            className="rounded-xl px-8 text-base border-neutral-700 text-white hover:bg-neutral-800"
                        >
